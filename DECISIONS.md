...
(D23 and D24 are held by uncommitted review entries in the `codex/demo-architecture-review`
worktree. Numbering continues at D25 to avoid a collision when that lands.)
